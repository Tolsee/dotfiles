...
- `codex/` - Codex-specific instructions, including Datadog login recovery
...
Codex's Datadog recovery rule starts the native OAuth login after an explicit
authentication failure; you complete the browser flow. Start a new Codex
session after installing the rule.
